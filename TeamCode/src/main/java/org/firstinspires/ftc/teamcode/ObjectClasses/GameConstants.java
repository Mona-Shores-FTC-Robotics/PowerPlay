...
public final class GameConstants {
    ...
    public static final double HIGH_CONE_JUNCTION_SCORE_HEIGHT_ENC_VAL = 3060;
    public static final double MEDIUM_CONE_JUNCTION_SCORE_HEIGHT_ENC_VAL = 2250;
    public static final double LOW_CONE_JUNCTION_SCORE_HEIGHT_ENC_VAL = 1275;
    ...
    public static final double TWO_CONE_STACK_INTAKE_HEIGHT_ENC_VAL = 51;
    public static final double THREE_CONE_STACK_INTAKE_HEIGHT_ENC_VAL = 145;
    public static final double FOUR_CONE_STACK_INTAKE_HEIGHT_ENC_VAL = 291;
    public static final double FIVE_CONE_STACK_INTAKE_HEIGHT_ENC_VAL = 550;
}
